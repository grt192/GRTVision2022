...
class Turret:
    ...
    def __init__(self):
        ...
        self.beta_value = 255 #subject to change
    ...
    def process(self, frame):
        ...
        # Change Brightness
        self.bright_frame = change_brightness(frame, self.beta_value)
        #
        # White balance the frame
        # self.white_balance_frame = white_balance(self.bright_frame)

        # Filter using HSV mask
        self.hsv_frame = cv2.cvtColor(self.bright_frame, cv2.COLOR_BGR2HSV)
